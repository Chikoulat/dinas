        ...
        <footer className={`space-y-3 p-4 bg-gray-200 ${is404 ? 'hidden' : ''}`}>
            <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col space-x-5 lg:space-x-10 text-xs lg:text-base">
                    <a href="https://maps.app.goo.gl/oXJmTyZCV7taKaaKA"
                       target="_blank">{t("Adresse")}: {t("Vila n°4, RC, Frantz Fanon, Boumerdes")}</a>
                        ...
                        <p className="text-xs lg:text-sm">{t("© 2025 Dinas Company")}</p>
